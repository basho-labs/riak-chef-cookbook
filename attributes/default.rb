...
default["riak"]["config"]["nodename"] = "riak@127.0.0.1"
default["riak"]["config"]["distributed_cookie"] = "riak"
default["riak"]["config"]["erlang"]["async_threads"] = 64
default["riak"]["config"]["erlang"]["max_ports"] = 65536
default["riak"]["config"]["ring_size"] = 64
default["riak"]["config"]["transfer_limit"] = 2
default["riak"]["config"]["ring"]["state_dir"] = "#{node["riak"]["platform_data_dir"]}/ring"
#default["riak"]["config"]["ssl"]["certfile"] = "/etc/riak/cert.pem"
#default["riak"]["config"]["ssl"]["keyfile"] = "/etc/riak/key.pem"
#default["riak"]["config"]["ssl"]["cacertfile"] = "/etc/riak/cacertfile.pem"
default["riak"]["config"]["dtrace"] = "off"
default["riak"]["config"]["strong_consistency"] = "off"
default["riak"]["config"]["listener"]["http"]["internal"] = "127.0.0.1:8098"
default["riak"]["config"]["listener"]["protobuf"]["internal"] = "127.0.0.1:8087"
...
default["riak"]["config"]["metadata_cache_size"] = "off"
...
default["riak"]["config"]["bitcask"]["data_root"] = "#{node["riak"]["platform_data_dir"]}/bitcask"
default["riak"]["config"]["bitcask"]["io_mode"] = "erlang"
default["riak"]["config"]["riak_control.top_level"] = "off"
default["riak"]["config"]["riak_control"]["auth"]["mode"] = "userlist"
default["riak"]["config"]["riak_control"]["auth"]["user"]["user"]["password"] = "pass"
default["riak"]["config"]["leveldb"]["data_root"] = "#{node["riak"]["platform_data_dir"]}/leveldb"
default["riak"]["config"]["leveldb"]["maximum_memory"]["percent"] = 80
default["riak"]["config"]["leveldb"]["compaction"]["trigger"]["tombstone_count"] = 1000
default["riak"]["config"]["jmx"] = "off"
...
default["riak"]["config"]["search"]["solr"]["jvm_options"] = "-Xms1g -Xmx1g -XX:+UseStringCache -XX:+UseCompressedOops"
default["riak"]["config"]["search"]["anti_entropy"]["data_dir"] = "#{node["riak"]["platform_data_dir"]}/yz_anti_entropy"
default["riak"]["config"]["search"]["root_dir"] = "#{node["riak"]["platform_data_dir"]}/yz"
