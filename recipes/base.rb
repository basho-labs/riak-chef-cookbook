...
if ["fedora", "centos", "redhat"].include?(node['platform']) and node['kernel']['machine'] == 'x86_64'
  node.set['riak']['config']['riak_core']['platform_lib_dir'] = "/usr/lib64/riak".to_erl_string
end
